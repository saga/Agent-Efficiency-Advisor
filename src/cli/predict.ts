...
const samples: ModelSizeFeatures[] = [
  // mini-like:简单任务,小 token,少工具
  {
    ...
    rollingAvgTokens: 2200,
    rollingAvgDuration: 4500,
    rollingAcceptRate: 0.92,
    emaTokens: 1800,
    emaRetryRate: 0,
    sessionsToday: 2,
  },
  // medium-like:中等复杂度
  {
    ...
    switchRate: 0.02,
    toolSuccessRate: 0.8,
    rollingAvgTokens: 18000,
    rollingAvgDuration: 40000,
    rollingAcceptRate: 0.78,
    emaTokens: 15000,
    emaRetryRate: 0.05,
    sessionsToday: 3,
  },
  // large-like:复杂任务,高 token,多工具,有循环
  {
    ...
    rollingAvgTokens: 65000,
    rollingAvgDuration: 140000,
    rollingAcceptRate: 0.65,
    emaTokens: 55000,
    emaRetryRate: 0.15,
    sessionsToday: 5,
  },
